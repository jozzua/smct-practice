...
class ProductCardPhotoTest extends TestCase
{
    ...
    public function test_catalog_uses_the_card_component_and_sku_seeded_photos(): void
    {
        ...
        $this->assertFileExists(public_path('images/products/SV-4340.jpeg'));
        ...
        $this->assertSame('/images/products/SV-4340.jpeg', $products[7]->imageUrl());
        $this->assertSame(
