...
- Restore boundary: treat the new skill, operator guide, discovery links, Kanban
  update, and these records as one tracked rehearsal change. Pre-existing checkout
  artifacts remain separate from this exercise. Obtain explicit approval before
  restoring or discarding either boundary.
